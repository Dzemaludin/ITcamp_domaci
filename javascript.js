...
// // pretrazivanje kljuca

// osoba1.location.forEach((el) => {
// console.log(el);
// });
...
//         book = library[i].author + " " + library[i].title 
...
// for(let i = 0; i < niz.length; i++) {
//     var vNiz = niz[i];
//     for(let j = 0; j < vNiz.length; j++) {
//         if(j < niz[i].length - 12) {
//             var vertikalniProizvod = niz[i][j] + niz[i][j+1] + niz[i][j+2] + niz[i][j+3] + niz[i][j+4] + niz[i][j+5] + niz[i][j+6] + niz[i][j+7] + niz[i][j+8] + niz[i][j+9] + niz[i][j+10] + niz[i][j+11] + niz[i][j+12];
